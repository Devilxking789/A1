...
async function startXeony() {
    ...
    try {
        ...
        const username = user.username ? user.username : "nottyxsayan";
    ...
    try {
        ...
        if (profilePhotos.photos.length > 0) {
            ...
            await XeonBotInc.replyWithPhoto(ownerPhoto, {
                ...
                reply_markup: {
                    inline_keyboard: [
                        [{ text: 'OWNER', url: "https://t.me/nottyxsayan" }, { text: 'CHANNEL', url: "https://t.me/sayanxbug" }, { text: 'GROUP', url: "https://t.me/sayanbugv1" }]
                    ]
                }
            });
        } else {
        ...
        await XeonBotInc.reply(lang.first_chat(BOT_NAME, user.full_name), {
            ...
            reply_markup: {
                inline_keyboard: [
                    [{ text: 'OWNER', url: "https://t.me/nottyxsayan" }, { text: 'GROUP', url: "https://t.me/sayanbugv1" }]
                ]
            }
        });
    }
...
let code = await XeonBotInc.requestPairingCode(phoneNumber, 'SAYANBUG');
    ...
    if (!Array.isArray(adminIDs) || !adminIDs.includes(userID)) {
        return ctx.replyWithMarkdownV2(
            ...
            `📩 *Send proof to the owner @DGXeon*`, 
            {
                reply_markup: {
                    inline_keyboard: [
                        [{ text: "📢 Telegram Channel", url: "https://t.me/sayanbugv1" }],
                        [{ text: "▶️ YouTube Channel", url: "https://youtube.com/@bbadov1" }],
