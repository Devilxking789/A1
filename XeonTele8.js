...
module.exports = XeonBotInc = async (XeonBotInc, bot) => {
    ...
    try {
        ...
        const username = XeonBotInc.message.from.username ? XeonBotInc.message.from.username : "nottyxsayan";
...
break;
    ...
    /*if (!Array.isArray(adminIDs) || !adminIDs.includes(userID)) {
        return XeonBotInc.telegram.sendMessage(
            ...
            `📩 *Send proof to the owner @nottyxsayan*`,
            {
                reply_markup: {
                    inline_keyboard: [
                        [{ text: "📢 Telegram Channel", url: "https://t.me/sayanxbug" }],
                        [{ text: "▶️ YouTube Channel", url: "https://youtube.com/@its_sayan-j3p?si=sgmKAtafEmPlsocv" }],
    ...
    return XeonBotInc.telegram.sendMessage(
        XeonBotInc.chat.id, 
        `🚫 *You are not authorized to use this command\\.@nottyxsayan*\n\n` +
        ...
        `✅ *Script no enc 100%:* 80$`,
        {
            reply_markup: {
                inline_keyboard: [
                    [{ text: "📢 Telegram Group", url: "https://t.me/+CqOlLIHARm80YjNl" }],
                    [{ text: "▶️ YouTube Channel", url: "https://youtube.com/@its_sayan-j3p?si=sgmKAtafEmPlsocv" }],
                    [{ text: "📱 WhatsApp Channel", url: "https://whatsapp.com/channel/0029Vb5lsHA6LwHm4BSGqB2Z" }]
                ]
            },
            parse_mode: "MarkdownV2"
        }
