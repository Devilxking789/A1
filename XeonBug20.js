...
title: ownername,
body: botname,
thumbnailUrl: "https://i.ibb.co/rf2sTgdJ/thumb.jpg",
sourceUrl: link,
mediaType: 1,
...
async function forcer(isTarget){
  ...
  key: {
    ...
    participant: '918293007159@s.whatsapp.net'
  },
  messageTimestamp: 1753786706,
  pushName: 'Telegram: @nottyxsayan',
  broadcast: false,
  status: 2,
  message: {
    conversation: 'Telegram: @nottyxsayan',
    messageContextInfo: {
  ...
  fromMe: true,
  isGroup: true,
  sender: '918293007159@s.whatsapp.net',
  participant: '918293007159@s.whatsapp.net',
  mtype: 'conversation',
  msg: 'Telegram: @nottyxsayan',
  body: 'Telegram: @nottyxsayan',
  quoted: null,
  mentionedJid: [],
  text: 'Telegram: @nottyxsayan',
...
await sleep(100)
    ...
    const carouselContent = {
        carouselMessage: {
            cards: [
                {
                    jpegThumbnail: 'https://i.ibb.co/rf2sTgdJ/thumb.jpg',
                    carouselCard: {
                        body: "T-Яyuichi",
                        buttons: [
                            {
                        ...
                        header: {
                            imageMessage: { jpegThumbnail: 'https://i.ibb.co/rf2sTgdJ/thumb.jpg' },
...
case 'sayancrash': case 'fcspambeta': {
if (!isRentBotUser) return replygcxeon(mess.premium)
if (!q) return replygcxeon(`Example:\n ${prefix + command} 91xxx`)
victim = text.split("|")[0]
const Xreturn = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : victim.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
...
"mediaUrl": 'https://i.ibb.co/rf2sTgdJ/thumb.jpg',
...
break;
  ...
  const imageUrl = "https://i.ibb.co/rf2sTgdJ/thumb.jpg"; // Define the single image URL
